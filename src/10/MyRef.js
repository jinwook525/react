  ...
  return (
    ...
    <div className="w-3/5 grid grid-cols-5 gap-2 p-2 bg-slate-200">
      <div className="flex justify-center items-center text-center ">
        <input ref={x} type='number' id='txt1' name='txt1' className="h-10 w-24 text-center" />
      </div>
      <div className="flex justify-center items-center text-2xl font-bold text-center">
        +
      </div>
      <div className="flex justify-center items-center text-center">
        <input ref={y} type='number' id='txt2' name='txt2' className="h-10 w-24 text-center" />
      </div>
      <div className="flex justify-center items-center text-center">
        <TailButton caption = '  =  '
                      color = 'orange'
      ...
      <div className="flex justify-center items-center text-center">
        <input ref={z} type='number' id='txt3' name='txt3' readOnly className="h-10 w-24 text-center" />
      </div>
    </div>
    </>
  )
